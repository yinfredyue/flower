...
class FitIns(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        clock : typing___Optional[builtin___int] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"parameters",b"parameters"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"clock",b"clock",u"config",b"config",u"parameters",b"parameters"]) -> None: ...
type___FitIns = FitIns

class ReadIns(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    min_clock: builtin___int = ...

    @property
    def fit_ins(self) -> type___FitIns: ...

    def __init__(self,
        *,
        min_clock : typing___Optional[builtin___int] = None,
        fit_ins : typing___Optional[type___FitIns] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"fit_ins",b"fit_ins"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"fit_ins",b"fit_ins",u"min_clock",b"min_clock"]) -> None: ...
type___ReadIns = ReadIns

class ReadRes(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    clock: builtin___int = ...
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"fit_ins",b"fit_ins",u"parameters",b"parameters"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"clock",b"clock",u"fit_ins",b"fit_ins",u"parameters",b"parameters"]) -> None: ...
type___ReadRes = ReadRes
...
class ServerMessage(google___protobuf___message___Message):
    ...
    class UpdateSIns(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        staleness_bound: builtin___int = ...

        def __init__(self,
            *,
            staleness_bound : typing___Optional[builtin___int] = None,
            ) -> None: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"staleness_bound",b"staleness_bound"]) -> None: ...
    type___UpdateSIns = UpdateSIns
    ...
    @property
    def read_res(self) -> type___ReadRes: ...

    @property
    def update_stale_ins(self) -> type___ServerMessage.UpdateSIns: ...
    ...
    def __init__(self,
        *,
        ...
        read_res : typing___Optional[type___ReadRes] = None,
        update_stale_ins : typing___Optional[type___ServerMessage.UpdateSIns] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"read_res",b"read_res",u"reconnect",b"reconnect",u"update_stale_ins",b"update_stale_ins"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"evaluate_ins",b"evaluate_ins",u"fit_ins",b"fit_ins",u"get_parameters",b"get_parameters",u"msg",b"msg",u"read_res",b"read_res",u"reconnect",b"reconnect",u"update_stale_ins",b"update_stale_ins"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["reconnect","get_parameters","fit_ins","evaluate_ins","read_res","update_stale_ins"]: ...
...
class ClientMessage(google___protobuf___message___Message):
    ...
    class FitRes(google___protobuf___message___Message):
        ...
        def HasField(self, field_name: typing_extensions___Literal[u"parameters",b"parameters"]) -> builtin___bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"clock",b"clock",u"fit_duration",b"fit_duration",u"num_examples",b"num_examples",u"num_examples_ceil",b"num_examples_ceil",u"parameters",b"parameters"]) -> None: ...
    ...
    @property
    def read_ins(self) -> type___ReadIns: ...
    ...
    def __init__(self,
        *,
        ...
        read_ins : typing___Optional[type___ReadIns] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"read_ins",b"read_ins"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"disconnect",b"disconnect",u"evaluate_res",b"evaluate_res",u"fit_res",b"fit_res",u"msg",b"msg",u"parameters_res",b"parameters_res",u"read_ins",b"read_ins"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"msg",b"msg"]) -> typing_extensions___Literal["disconnect","parameters_res","fit_res","evaluate_res","read_ins"]: ...

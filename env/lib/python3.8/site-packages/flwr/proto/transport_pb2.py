...
_FITINS_CONFIGENTRY = _descriptor.Descriptor(
  name='ConfigEntry',
  full_name='flower.transport.FitIns.ConfigEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='flower.transport.FitIns.ConfigEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='flower.transport.FitIns.ConfigEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FITINS = _descriptor.Descriptor(
  name='FitIns',
  full_name='flower.transport.FitIns',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parameters', full_name='flower.transport.FitIns.parameters', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='config', full_name='flower.transport.FitIns.config', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clock', full_name='flower.transport.FitIns.clock', index=2,
  ...
  nested_types=[_FITINS_CONFIGENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_READINS = _descriptor.Descriptor(
  name='ReadIns',
  full_name='flower.transport.ReadIns',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_clock', full_name='flower.transport.ReadIns.min_clock', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fit_ins', full_name='flower.transport.ReadIns.fit_ins', index=1,
...
_READRES = _descriptor.Descriptor(
  name='ReadRes',
  full_name='flower.transport.ReadRes',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parameters', full_name='flower.transport.ReadRes.parameters', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fit_ins', full_name='flower.transport.ReadRes.fit_ins', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clock', full_name='flower.transport.ReadRes.clock', index=2,
      number=3, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVERMESSAGE_UPDATESINS = _descriptor.Descriptor(
  name='UpdateSIns',
  full_name='flower.transport.ServerMessage.UpdateSIns',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='staleness_bound', full_name='flower.transport.ServerMessage.UpdateSIns.staleness_bound', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVERMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_res', full_name='flower.transport.ServerMessage.read_res', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='update_stale_ins', full_name='flower.transport.ServerMessage.update_stale_ins', index=5,
  ...
  nested_types=[_SERVERMESSAGE_RECONNECT, _SERVERMESSAGE_GETPARAMETERS, _SERVERMESSAGE_EVALUATEINS, _SERVERMESSAGE_UPDATESINS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_CLIENTMESSAGE_FITRES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clock', full_name='flower.transport.ClientMessage.FitRes.clock', index=4,
...
_CLIENTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='read_ins', full_name='flower.transport.ClientMessage.read_ins', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FITINS_CONFIGENTRY.containing_type = _FITINS
_FITINS.fields_by_name['parameters'].message_type = _PARAMETERS
_FITINS.fields_by_name['config'].message_type = _FITINS_CONFIGENTRY
_READINS.fields_by_name['fit_ins'].message_type = _FITINS
_READRES.fields_by_name['parameters'].message_type = _PARAMETERS
_READRES.fields_by_name['fit_ins'].message_type = _FITINS
...
_SERVERMESSAGE_UPDATESINS.containing_type = _SERVERMESSAGE
...
_SERVERMESSAGE.fields_by_name['fit_ins'].message_type = _FITINS
_SERVERMESSAGE.fields_by_name['evaluate_ins'].message_type = _SERVERMESSAGE_EVALUATEINS
_SERVERMESSAGE.fields_by_name['read_res'].message_type = _READRES
_SERVERMESSAGE.fields_by_name['update_stale_ins'].message_type = _SERVERMESSAGE_UPDATESINS
...
_SERVERMESSAGE.oneofs_by_name['msg'].fields.append(
  _SERVERMESSAGE.fields_by_name['read_res'])
_SERVERMESSAGE.fields_by_name['read_res'].containing_oneof = _SERVERMESSAGE.oneofs_by_name['msg']
_SERVERMESSAGE.oneofs_by_name['msg'].fields.append(
  _SERVERMESSAGE.fields_by_name['update_stale_ins'])
_SERVERMESSAGE.fields_by_name['update_stale_ins'].containing_oneof = _SERVERMESSAGE.oneofs_by_name['msg']
...
_CLIENTMESSAGE.fields_by_name['read_ins'].message_type = _READINS
...
_CLIENTMESSAGE.oneofs_by_name['msg'].fields.append(
  _CLIENTMESSAGE.fields_by_name['read_ins'])
_CLIENTMESSAGE.fields_by_name['read_ins'].containing_oneof = _CLIENTMESSAGE.oneofs_by_name['msg']
DESCRIPTOR.message_types_by_name['Parameters'] = _PARAMETERS
DESCRIPTOR.message_types_by_name['FitIns'] = _FITINS
DESCRIPTOR.message_types_by_name['ReadIns'] = _READINS
DESCRIPTOR.message_types_by_name['ReadRes'] = _READRES
...
FitIns = _reflection.GeneratedProtocolMessageType('FitIns', (_message.Message,), {
  ...
  'ConfigEntry' : _reflection.GeneratedProtocolMessageType('ConfigEntry', (_message.Message,), {
    ...
    '__module__' : 'transport_pb2'
    # @@protoc_insertion_point(class_scope:flower.transport.FitIns.ConfigEntry)
    })
  ,
  'DESCRIPTOR' : _FITINS,
  '__module__' : 'transport_pb2'
  # @@protoc_insertion_point(class_scope:flower.transport.FitIns)
  })
_sym_db.RegisterMessage(FitIns)
_sym_db.RegisterMessage(FitIns.ConfigEntry)

ReadIns = _reflection.GeneratedProtocolMessageType('ReadIns', (_message.Message,), {
  'DESCRIPTOR' : _READINS,
  '__module__' : 'transport_pb2'
  # @@protoc_insertion_point(class_scope:flower.transport.ReadIns)
  })
_sym_db.RegisterMessage(ReadIns)

ReadRes = _reflection.GeneratedProtocolMessageType('ReadRes', (_message.Message,), {
  'DESCRIPTOR' : _READRES,
  '__module__' : 'transport_pb2'
  # @@protoc_insertion_point(class_scope:flower.transport.ReadRes)
  })
_sym_db.RegisterMessage(ReadRes)
...
ServerMessage = _reflection.GeneratedProtocolMessageType('ServerMessage', (_message.Message,), {
  ...
  'UpdateSIns' : _reflection.GeneratedProtocolMessageType('UpdateSIns', (_message.Message,), {
    'DESCRIPTOR' : _SERVERMESSAGE_UPDATESINS,
    '__module__' : 'transport_pb2'
    # @@protoc_insertion_point(class_scope:flower.transport.ServerMessage.UpdateSIns)
    })
  ,
...
_sym_db.RegisterMessage(ServerMessage.UpdateSIns)

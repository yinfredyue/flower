...
_SERVERMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_SERVERMESSAGE_RECONNECT, _SERVERMESSAGE_GETPARAMETERS, _SERVERMESSAGE_EVALUATEINS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,

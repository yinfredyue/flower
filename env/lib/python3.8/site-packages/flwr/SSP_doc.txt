...
When all clients are connected, the server starts one thread for each client. In each thread, the
server sends FitIns for r times, where r is the number of rounds to train.

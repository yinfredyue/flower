...
from .numpy_client import NumPyClient, NumPyClientWrapper, NumPyClientSSPWrapper, NumPyClientSSPStragglerWrapper
...
def start_numpy_client_ssp(
    server_address: str,
    client: NumPyClient,
    grpc_max_message_length: int = GRPC_MAX_MESSAGE_LENGTH,
) -> None:
    """The same as start_numpy_client, except for using NumPyClientSSPWrapper"""

    # Wrap the NumPyClientSSPWrapper
    flower_client = NumPyClientSSPWrapper(client)
...
# Only for simulating stragglers
def start_numpy_client_ssp_straggler(
    server_address: str,
    client: NumPyClient,
    grpc_max_message_length: int = GRPC_MAX_MESSAGE_LENGTH,
) -> None:
    """The same as start_numpy_client, except for using NumPyClientSSPStragglerWrapper"""

    # Wrap the NumPyClientSSPWrapper
    flower_client = NumPyClientSSPStragglerWrapper(client)

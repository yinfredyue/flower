...
from .numpy_client import NumPyClient, NumPyClientWrapper, NumPyClientSSPWrapper
    ...
    while True:
        ...
        with insecure_grpc_connection(
            ...
            while True:
                ...
                log(DEBUG, "Received server message. Handling...")
...
def start_numpy_client_ssp(
    ...
    flower_client = NumPyClientSSPWrapper(
        client,
        staleness_bound,
        delay=delay,
        min_delay=min_delay,
        max_delay=max_delay,
        switchpoint_strategy=switchpoint_strategy,
    )

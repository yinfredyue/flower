...
class FlowerServiceServicer(transport_pb2_grpc.FlowerServiceServicer):
    ...
    def Join(  # pylint: disable=invalid-name
        ...
        is_success2 = True if self.server_ssp is None else False
        if self.server_ssp is not None:
            is_success2 = self.server_ssp.register_client(cid)
